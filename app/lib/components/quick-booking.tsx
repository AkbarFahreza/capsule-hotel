...
export default function QuickBooking() {
  ...
  return (
    <div className="lg:rounded-2xl rounded-[7px] py-5 px-5 lg:py-10 lg:px-10 bg-white z-10 absolute top-[60%] mx-auto left-1/2 -translate-x-1/2 w-full shadow-md lg:w-10/12 flex flex-col gap-12">
      <div>
